...
const tools = [
  ...
  },
  {
    ...
    description: "Plan your retirement savings. Estimate how much you need to save with compound interest projections and the 4% rule.",
  ...
  },
  {
    ...
    description: "Convert between hourly, weekly, monthly, and annual salary. Perfect for job offers and budgeting.",
  ...
  },
  {
    ...
    description: "Convert between 15 major world currencies with live exchange rates. Supports USD, EUR, GBP, CNY, JPY, and more.",
  ...
  },
  {
    ...
    description: "Calculate monthly car payments, total interest, and total cost. Compare terms from 36 to 84 months.",
  ...
  },
  {
    ...
    description: "Find out how long to pay off credit card debt and how much interest you'll pay. Plan your debt payoff strategy.",
  ...
  },
  {
    ...
    description: "Full amortization schedule for loans and mortgages. See monthly principal vs interest breakdown.",
  ...
  },
  {
    ...
    description: "Estimate your body fat percentage using the US Navy method. Measure waist, neck, and hip circumference.",
  ...
  },
  {
    ...
    description: "Calculate your exact age in years, months, days, hours, and minutes. Includes zodiac sign and birthday countdown.",
    href: "/age-calculator",
    icon: "🎂",
    category: "Tools",
  },
  {
    ...
    description: "Calculate the difference between two dates, or add/subtract days from any date. Great for planning and counting days.",
  ...
  },
  {
    ...
    description: "Calculate percentages, percent change, and tips. Fast and easy percentage calculator for everyday math.",
